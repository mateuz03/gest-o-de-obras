...
export default function LojasPendentes() {
  ...
  async function carregarLojas() {
    ...
    try {
      ...
      setLojas((data as unknown as Loja[]) || []);
    } catch (err) {
  ...
  const total = useMemo(() => lojas.length, [lojas]);
              ...
              <CardContent className="p-5">
                <div className="flex items-start gap-3">
                  <div className="flex h-14 w-14 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-slate-100 bg-slate-50">
                    {loja.logo_url ? (
                      <img src={loja.logo_url} alt={loja.nome_loja} className="h-full w-full object-cover" />
                    ) : (
                ...
                <div className="flex items-center gap-4">
                  <div className="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-slate-100 bg-slate-50">
                    {selecionada.logo_url ? (
                      <img src={selecionada.logo_url} alt={selecionada.nome_loja} className="h-full w-full object-cover" />
                    ) : (
      ...
      <AlertDialog open={confirmRecusar} onOpenChange={(o) => { setConfirmRecusar(o); if (!o) setMotivo(""); }}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Informe uma justificativa rápida. O lojista verá esse motivo e poderá corrigir os dados para reenviar.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <div className="py-1">
