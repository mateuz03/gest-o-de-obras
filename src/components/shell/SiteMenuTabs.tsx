      ...
      {sections.map((section) => {
        ...
        return (
          <div
            ...
            onMouseLeave={() =>
              setOpenSection((current) => (current === section.label ? null : current))
            }
          >
            <button
              type="button"
            ...
            <div
              ...
              } rounded-[20px] border border-slate-200/90 bg-white p-3 shadow-[0_18px_48px_rgba(15,23,42,0.12)] transition-all duration-150 ${
                isOpen
