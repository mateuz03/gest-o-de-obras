...
function normalizeBudgetItem(raw: any, index = 0): BudgetItem {
  ...
  return {
    ...
    modo_conciliacao: typeof raw?.modo_conciliacao === "string" ? raw.modo_conciliacao : "",
    match_confidence: typeof raw?.match_confidence === "string" ? raw.match_confidence : "",
    match_score: toNumber(raw?.match_score, 0),
    match_candidates: Array.isArray(raw?.match_candidates) ? raw.match_candidates : [],
  } as BudgetItem;
}
